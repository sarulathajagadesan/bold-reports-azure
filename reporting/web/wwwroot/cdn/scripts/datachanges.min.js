...
*  applicable laws. 
*/
function(e){"function"==typeof define&&define.amd?define(["./../common/ej.globalize.min","./../common/ej.core.min","./../common/ej.scroller.min","./ej.datepicker.min","./ej.timepicker.min"],e):e()}(function(){"use strict";var e=this&&this.__extends||function(e,t){function i(){this.constructor=e}for(var s in t)t.hasOwnProperty(s)&&(e[s]=t[s]);i.prototype=t.prototype,e.prototype=new i},t=function(t){function i(e){return t.call(this),this._rootCSS="e-daterangepicker",this._setFirst=!1,this.PluginName="ejDateRangePicker",this.id="myDateRange",this._addToPersist=["value"],this.type="editor",this.angular={require:["?ngModel","^?form","^?ngModelOptions"],requireFormatters:!0},this.model=null,this.validTags=["input"],this.defaults={height:"",width:"",value:"",cssClass:"",enabled:!0,startDate:null,endDate:null,enableTimePicker:!1,ranges:null,locale:"en-US",separator:"-",watermarkText:"Select Range",dateFormat:"",timeFormat:"",showPopupButton:!0,showRoundedCorner:!1,allowEdit:!0,enablePersistence:!1},this._isIE8="msie"==ej.browserInfo().name&&"8.0"==ej.browserInfo().version,this._prevValue=null,this._validState=null,i.prototype.observables=["value"],e&&(e.jquery||(e=$("#"+e)),e.length)?$(e).ejDateRangePicker().data(this.PluginName):void 0}return e(i,t),i.prototype.setModel=function(e,t){this.setModel(e,t)},i.prototype.option=function(e,t){this.option(e,t)},i.prototype._setModel=function(e){var t;for(t in e)switch(t){case"allowEdit":e[t]||(this.element.attr("readonly","readonly"),this.element.on("mousedown",$.proxy(this._showDatePopUp,this)),this.element.off("blur",$.proxy(this._onMainFocusOut,this)));break;case"startDate":0==this._validateValues(e[t],"left")?e[t]=null:(this._startEndValidation()||null==this.model.endDate||(this._resetValues(),this.model.endDate=null),this._updateValues(),this._selectedStartDate=this.model.startDate,e[t]=this.model.startDate);break;case"endDate":0==this._validateValues(e[t],"right")?e[t]=null:(this._startEndValidation()||(this._rightDP.element.parents(".e-datewidget").addClass("e-val-error"),this.model.endDate=null),this._updateValues(),e[t]=this.model.endDate);break;case"enableTimePicker":this.model.enableTimePicker=e[t],e[t]?this._renderTimePicker():this._removeTimePicker(),this._scrollerObj&&(this._scrollerObj.model.height=this.datePopup.height(),this._scrollerObj.refresh());break;case"locale":this._setCulture(e[t]),e[t]=this.model.locale;break;case"separator":this.model.separator=e[t],this._mainValue();break;case"dateFormat":this._leftDP&&this._leftDP.option(t,e[t]),this._rightDP&&this._rightDP.option(t,e[t]),this.model.dateFormat=e[t],this._getDateTimeFormat(),this._updateInput();break;case"timeFormat":this._leftTP&&this._leftTP.option(t,e[t]),this._rightTP&&this._rightTP.option(t,e[t]),this.model.timeFormat=e[t],this._getDateTimeFormat(),this._updateInput();break;case"watermarkText":ej.isNullOrUndefined(this._options)&&(this._options={}),this._options.watermarkText=this.model.watermarkText=e[t],this._localizedLabels.watermarkText=this.model.watermarkText,this._setWaterMark();break;case"cssClass":this._changeSkin(e[t]);break;case"showRoundedCorner":this._setRoundedCorner(e[t]);break;case"showPopupButton":this._renderDateIcon(e[t]);break;case"value":this.element.val(e[t]),this._onMainFocusOut(),e[t]=this.model.value;break;case"height":this.wrapper.height(e[t]);break;case"width":this.wrapper.width(e[t]);break;case"enabled":e[t]?this.enable():this.disable()}},i.prototype._init=function(e){this._options=e,this._flagevents=!1,this._id=this.element.attr("id"),this._isSupport=null!=document.createElement("input").placeholder,""==this.element.val()&&this.model.value&&this.element.val(this.model.value),this.element.val()&&this._setInitValue(),this._createDateRangePicker(),0==this._validState&&this.element.val()&&this.wrapper.addClass("e-error"),this._popupOpen=!1,this._isPopScroll=!1,this.model.enabled||this.disable(),this._wireEvents()},i.prototype._setInitValue=function(){var e=this.element.val().split(this.model.separator),t=ej.parseDate(e[0],this._dateTimeFormat,this.model.locale),i=ej.parseDate(e[1],this._dateTimeFormat,this.model.locale);t&&i&&(this.model.startDate=t,this.model.endDate=i)},i.prototype._getNextMonth=function(e){var t,i,s,a=e;return a instanceof Date?(11==(t=a.getMonth())?(i=a.getFullYear()+1,t=-1):i=a.getFullYear(),s=new Date,s=new Date(s.setFullYear(i)),s=new Date(s.setMonth(t+1)),new Date(s.setDate(1))):new Date},i.prototype._getDateTimeFormat=function(){var e=ej.preferredCulture(this.model.locale).calendars.standard.patterns;this.model.dateFormat||(this.model.dateFormat=e.d),this.model.enableTimePicker?(this.model.timeFormat||(this.model.timeFormat=e.t),this._dateTimeFormat=this.model.dateFormat+" "+this.model.timeFormat):this._dateTimeFormat=this.model.dateFormat},i.prototype._setValues=function(){this._leftDP.option("value",this.model.startDate),this._rightDP.option("value",this.model.endDate||null),this.model.startDate&&this._setStartDate(this.model.startDate,$('.current-month[date="'+this.model.startDate.toDateString()+'"]'),!0),this.model.endDate&&this._setEndDate(this.model.endDate,$('.current-month[date="'+this.model.endDate.toDateString()+'"]'),!0),this._rangeRefresh(this._setArgs(this._leftDP.popup)),this._rangeRefresh(this._setArgs(this._rightDP.popup)),this._rightDP.element.parents(".e-datewidget").removeClass("e-error"),this.model.enableTimePicker&&(this._leftTP.option("value",this.model.startDate),this._rightTP.option("value",this.model.endDate)),this._updateRanges("left"),this._updateRanges("right")},i.prototype._customSet=function(){this._selectedStartDate=this.model.startDate,this._selectedEndDate=this.model.endDate,this._resetValues(),this._setValues(),this._popupOpen||this._mainValue(),this._refreshMinMax(),this._setWaterMark()},i.prototype._setCulture=function(e){e=ej.preferredCulture(e).name,this.model.locale=e,this._setOption("locale",e),this._localizedLabels=this._getLocalizedLabels(),this._setLocalizedText(),this._updateInput()},i.prototype._setRoundedCorner=function(e){e?(this._input_innerWrapper.addClass("e-corner"),this.popup.addClass("e-corner")):(this._input_innerWrapper.removeClass("e-corner"),this.popup.removeClass("e-corner")),this._setOption("showRoundedCorner",e)},i.prototype._renderDateIcon=function(e){e?(this.dateRangeIcon=ej.buildTag("span.e-select#"+this.id+"-img","",{},this._isIE8?{unselectable:"on"}:{}).append(ej.buildTag("span.e-icon e-calendar","",{},{"aria-label":"Select"}).attr(this._isIE8?{unselectable:"on"}:{})).insertAfter(this.element),this._input_innerWrapper.addClass("e-padding"),this._on(this.dateRangeIcon,"mousedown",this._showDatePopUp),this._off(this.dateRangeIcon,"click",this._showDatePopUp)):(this.dateRangeIcon&&this.dateRangeIcon.remove(),this._input_innerWrapper.removeClass("e-padding"),this._bindDateButton(),this._off(this.dateRangeIcon,"click",this._showDatePopUp))},i.prototype._validateValues=function(e,t){"right"==t?this._rightDP:this._leftDP;var i=e;if(null!=i&&"string"==typeof i)"left"==t?(this.model.startDate=ej.parseDate(e,this.model.dateFormat,this.model.locale)||null,this.model.startDate=null!=this.model.startDate?this.model.startDate:new Date(i)):(this.model.endDate=ej.parseDate(e,this.model.dateFormat,this.model.locale)||null,this.model.endDate=null!=this.model.endDate?this.model.endDate:new Date(i));else{if(!(e instanceof Date))return!1;if("left"==t){if(this.model.startDate=e,isNaN(e.getDate()))return!1;"string"!=typeof this._formatter(this.model.startDate,this.model.locale)&&(this.model.startDate=ej.parseDate(this._formatter(this.model.startDate,this.model.locale),this.model.dateFormat))}else if("right"==t){if(this.model.endDate=e,isNaN(e.getDate()))return!1;"string"!=typeof this._formatter(this.model.endDate,this.model.locale)&&(this.model.endDate=ej.parseDate(this._formatter(this.model.endDate,this.model.locale),this.model.dateFormat))}}return!0},i.prototype._formatter=function(e,t){var i=this._checkFormat(t);return ej.format(e,i,this.model.locale)},i.prototype._checkFormat=function(e){var t=this,i=this._regExp();return e.replace(i,function(e){return"/"===e&&"/"!==ej.preferredCulture(t.model.locale).calendars.standard["/"]?"'/'":e})},i.prototype._regExp=function(){return/\/dddd|ddd|dd|d|MMMM|MMM|MM|M|yyyy|yy|HH|H|hh|h|mm|m|fff|ff|f|tt|ss|s|zzz|zz|z|gg|g|"[^"]*"|'[^']*'|[/]/g},i.prototype._setArgs=function(e){var t=new Date($(e.find(".current-month")[0]).attr("date"));return this.args={},this.args.element=e,this.args.month=t.getMonth(),this.args.year=t.getFullYear(),this.args},i.prototype._changeSkin=function(e){this.wrapper.removeClass(this.model.cssClass).addClass(e),this.popup.removeClass(this.model.cssClass).addClass(e),this._setOption("cssClass",e)},i.prototype._createDateRangePicker=function(){var e;this._localizedLabels=this._getLocalizedLabels(),this.element.addClass("e-input").attr({"aria-atomic":"true","aria-live":"assertive",tabindex:"0"}),this.wrapper=ej.buildTag("span.e-daterangewidget e-widget "+this.model.cssClass),ej.isTouchDevice()||this.wrapper.addClass("e-ntouch"),this._input_innerWrapper=ej.buildTag("span.e-in-wrap e-box"),this.wrapper.append(this._input_innerWrapper).insertBefore(this.element),this._input_innerWrapper.append(this.element),this._input_innerWrapper.addClass("e-padding"),this.popup=ej.buildTag("div.e-daterangepicker-popup e-popup e-widget e-box"+this.model.cssClass+"#"+this.element[0].id+"_popup").css("display","none"),this._isSupport||(this._hiddenInput=ej.buildTag("input.e-input e-placeholder ","",{},{type:"text"}).insertAfter(this.element),this._hiddenInput.val(this._localizedLabels.watermarkText),this._hiddenInput.css("display","block"),e=this,$(this._hiddenInput).focus(function(){e.element.focus()})),$("body").append(this.popup),this.datePopup=ej.buildTag("div.e-datepickers-popup"),this.popup.append(this.datePopup),this._leftDiv=ej.buildTag("div.e-left-datepicker"),this._rightDiv=ej.buildTag("div.e-right-datepicker"),this.datePopup.append(this._leftDiv),this.datePopup.append(this._rightDiv),this.calendar_left=ej.buildTag("input.leftDate_wrapper#"+this.element[0].id+"leftDate_wrapper","",{},{type:"text"}),this._leftDiv.append(this.calendar_left),this.calendar_right=ej.buildTag("input.rightDate_wrapper#"+this.element[0].id+"rightDate_wrapper","",{},{type:"text"}),this._rightDiv.append(this.calendar_right),e=this,this.culture=ej.preferredCulture(this.model.locale),this._getDateTimeFormat(),this._setRoundedCorner(this.model.showRoundedCorner),this._renderDateIcon(this.model.showPopupButton),this.calendar_left.ejDatePicker({displayInline:!0,showFooter:!1,watermarkText:"",width:"100%",enableStrictMode:!0,layoutChange:function(){e._refreshEvents("left"),e._updateRanges("left"),e._scrollerObj&&(e._scrollerObj.model.height=e.datePopup.height(),e._scrollerObj.refresh())},showTooltip:!1,locale:this.model.locale,dateFormat:this.model.dateFormat,_month_Loaded:function(t){e._previousNextHandler(t)},enablePersistence:this.model.enablePersistence}),this._leftDP=this.calendar_left.data("ejDatePicker"),this._leftDP._getInternalEvents=!0,this._leftDP._DRPdisableFade=!0,this._leftDP.option("showPopupButton",!1),this._leftDP.popup.css({position:"static",visibility:"inherit"}),this.calendar_right.ejDatePicker({displayInline:!0,width:"100%",showFooter:!1,watermarkText:"",enableStrictMode:!0,locale:this.model.locale,create:$.proxy(this._updateOnRender,this),layoutChange:function(){e._refreshEvents("right"),e._updateRanges("right"),e._scrollerObj&&(e._scrollerObj.model.height=e.datePopup.height(),e._scrollerObj.refresh())},dateFormat:this.model.dateFormat,_month_Loaded:function(t){e._previousNextHandler(t)},enablePersistence:this.model.enablePersistence}),this._rightDP=this.calendar_right.data("ejDatePicker"),this._rightDP._getInternalEvents=!0,this._rightDP._DRPdisableFade=!0,this._rightDP.option("showPopupButton",!1),this._rightDP.popup.css({position:"static",visibility:"inherit"}),this.model.ranges&&this._renderRanges(),this.model.enableTimePicker&&this._renderTimePicker(),this._renderButton(),this._bindDateButton(),this._refreshEvents("left"),this._refreshEvents("right"),this._updateRanges("left"),this._updateRanges("right"),this.wrapper&&(this.model.width&&this.wrapper.width(this.model.width),this.model.height&&this.wrapper.height(this.model.height))},i.prototype._updateOnRender=function(){this.model.enableTimePicker?this._rightTime&&(this._rightTP=this._rightTime.ejTimePicker("instance"),this._updateValues()):this.calendar_right&&(this._rightDP=this.calendar_right.ejDatePicker("instance"),this._updateValues())},i.prototype._updateRangesList=function(){$(".e-dateranges-ul").find(".rangeItem.e-active").removeClass("e-active"),$(".e-dateranges-ul").find(".rangeItem.e-custompic").addClass("e-active")},i.prototype._updateValues=function(){this._updateRangesList(),this._getDateTimeFormat(),this._startEndValidation()||null!=this.model.startDate&&null==this.model.endDate?(this._validateValues(this.model.startDate,"left"),this._validateValues(this.model.endDate,"right"),this._setValues(),this._mainValue()):(this._clearRanges(),this.element.val("")),this._refreshMinMax(),this._setWaterMark()},i.prototype._startEndValidation=function(){if(this.model.startDate&&this.model.endDate){var e=this.model.startDate,t=this.model.endDate;return!(t&&e>t)}return!1},i.prototype._renderButton=function(){this._buttonDiv=ej.buildTag("div.e-drpbuttons");var e=ej.buildTag("div.e-drp-button e-drp-reset e-btn e-select e-flat").attr({tabindex:"0"}),t=ej.buildTag("div.e-drp-button e-drp-apply e-disable e-btn e-select e-flat").attr({tabindex:"0"}),i=ej.buildTag("div.e-drp-button e-drp-cancel e-btn e-select e-flat").attr({tabindex:"0"});this._buttonDiv.append(e),this._buttonDiv.append(t),this._buttonDiv.append(i),this.popup.append(this._buttonDiv),this._setLocalizedText()},i.prototype._setLocalizedText=function(){ej.isNullOrUndefined(this._options)||(ej.isNullOrUndefined(this._options.buttonText)||$.extend(this._localizedLabels.ButtonText,this._options.buttonText),ej.isNullOrUndefined(this._options.watermarkText)||(this._localizedLabels.watermarkText=this._options.watermarkText)),this.model.buttonText=this._localizedLabels.ButtonText,$(this._buttonDiv.find("div.e-drp-reset")).text(this.model.buttonText.reset),$(this._buttonDiv.find("div.e-drp-apply")).text(this.model.buttonText.apply),$(this._buttonDiv.find("div.e-drp-cancel")).text(this.model.buttonText.cancel),this._customRangePicker&&this._customRangePicker.find("ul li.e-custompic").length>0&&this._customRangePicker.find("ul li.e-custompic").text(this._localizedLabels.customPicker),this._setWaterMark()},i.prototype._renderRanges=function(){var e,t,i,s,a;if(this._renderRangesWrapper(),this.popup.append(this._customRangePicker),this._ranges_li="",this.model.ranges)for(e=0;e<this.model.ranges.length;e++)2===(i=(t=this.model.ranges[e]).range).length&&(s=new Date(i[0]),a=new Date(i[1]),ej.isNullOrUndefined(s)&&(s=new Date(i[0])),ej.isNullOrUndefined(a)&&(a=new Date(i[1])),s<=a&&(this._ranges_li+="<li aria-selected='false' title='"+t.label+"' class='rangeItem' e-date-range='"+JSON.stringify(i)+"' e-data-value='"+t.range+"'>"+t.label+"</li>"));this._ranges_li+="<li aria-selected='false' class='rangeItem e-active e-custompic' e-date-range='customPicker'>"+this._localizedLabels.customPicker+"</li>",this.popup.find("div.e-custom-dateranges ul").append(this._ranges_li),this._on(this._customRangePicker.find("ul li.rangeItem"),"click",this._customSelection),this._customRangePicker.ejScroller({height:this.datePopup.height(),width:0,scrollerSize:15}),this._scrollerObj=this._customRangePicker.ejScroller("instance")},i.prototype._removeTimePicker=function(){this._leftDiv.removeClass("e-left-timepicker"),this._rightDiv.removeClass("e-right-timepicker"),this._leftTP.destroy(),this._rightTP.destroy(),this._rightTP=null,this._leftTP=null,this._leftTime.remove(),this._rightTime.remove(),this._setOption("width",""),this._setOption("width","100%"),this._updateValues()},i.prototype._setOption=function(e,t){this._leftDP&&this._leftDP.option(e,t),this._rightDP&&this._rightDP.option(e,t),this.model.enableTimePicker&&(this._leftTP&&this._leftTP.option(e,t),this._rightTP&&this._rightTP.option(e,t))},i.prototype._renderTimePicker=function(){""==this.model.timeFormat&&(this.model.timeFormat=this.culture.calendar.patterns.t),this._leftTime=ej.buildTag("input.leftTime#"+this._id+"_lTime"),this._leftDiv.append(this._leftTime),this._leftDiv.addClass("e-left-timepicker");var e=this;this._leftTime.ejTimePicker({width:"100px",popupWidth:"100px",locale:this.model.locale,timeFormat:this.model.timeFormat,select:function(t){e.model.startDate&&e.model.endDate&&(e._rightTP&&e.model.startDate.toLocaleDateString()==e.model.endDate.toLocaleDateString()&&e._rightTP.option("minTime",t.value),e._buttonDiv.find(".e-drp-apply").removeClass("e-disable"))}}),this._leftTP=this._leftTime.ejTimePicker("instance"),this._leftTP.popup.addClass("e-daterange-timepopup"),this._rightTime=ej.buildTag("input.rightTime#"+this._id+"_rTime"),this._rightDiv.append(this._rightTime),this._rightDiv.addClass("e-right-timepicker"),this._rightTime.ejTimePicker({width:"100px",popupWidth:"100px",locale:this.model.locale,create:$.proxy(this._updateOnRender,this),timeFormat:this.model.timeFormat,select:function(){e.model.startDate&&e.model.endDate&&e._buttonDiv.find(".e-drp-apply").removeClass("e-disable")}}),this._rightTP=this._rightTime.ejTimePicker("instance"),this._rightTP.popup.addClass("e-daterange-timepopup"),this._on(this._leftTP.element,"keydown",this._onKeyDown),this._on(this._rightTP.element,"keydown",this._onKeyDown),this._setTimePickerPos()},i.prototype._setTimePickerPos=function(){$("#"+this._id+"_lTime_timewidget").css({position:"absolute",top:0,left:this._leftDP.popup.width()+this._leftDP.popup.position().left-this.popup.find($("#"+this._id+"_lTime_timewidget")).outerWidth()}),$("#"+this._id+"_rTime_timewidget").css({position:"absolute",top:this.popup.hasClass("e-daterange-responsive")?this._rightDP.wrapper.position().top:0,left:this._rightDP.popup.width()+this._rightDP.popup.position().left-this.popup.find($("#"+this._id+"_rTime_timewidget")).outerWidth()}),this.popup.find($(".e-left-datepicker .e-datewidget")).css({width:this._leftDP.popup.width()-this.popup.find($("#"+this._id+"_lTime_timewidget")).width()-1}),this.popup.find($(".e-right-datepicker .e-datewidget")).css({width:this._rightDP.popup.width()-this.popup.find($("#"+this._id+"_rTime_timewidget")).width()-1})},i.prototype._updateInput=function(){if(!this.model.startDate||!this.model.endDate)return this.model.value&&this.element.val(this.model.value),void(this._popupOpen&&this.popupHide());this._resetValues(),this.wrapper.removeClass("e-error"),this._mainValue(),this._refreshMinMax()},i.prototype._removeWatermark=function(){""==this.element.val()||this._isSupport||this._hiddenInput.css("display","none")},i.prototype._mainValue=function(){var e="",t="",i=this.model.startDate,s=this.model.endDate,a=ej.format(i,this.model.dateFormat,this.model.locale),n=ej.format(s,this.model.dateFormat,this.model.locale);this.model.enableTimePicker&&this._leftTP&&this._rightTP&&this._leftTP.model.value&&this._rightTP.model.value?(e=this._leftTP.model.value,t=this._rightTP.model.value,a=ej.format(a+" "+e,this._dateTimeFormat,this.model.locale),n=ej.format(n+" "+t,this._dateTimeFormat,this.model.locale),this.model.startDate=ej.parseDate(a,this._dateTimeFormat,this.model.locale),this.model.endDate=ej.parseDate(n,this._dateTimeFormat,this.model.locale)):(this.model.startDate=ej.parseDate(a,this._leftDP.model.dateFormat,this.model.locale),this.model.endDate=ej.parseDate(n,this._rightDP.model.dateFormat,this.model.locale)),null!=a&&null!=n?(this.model.value=a+" "+this.model.separator+" "+n,this.element.val(this.model.value),this._hiddenInput&&this._hiddenInput.attr("value",this.model.value),this._removeWatermark(),this._validState=!0):(this.model.value=null,this._setWaterMark(),this._validState=!1),this._prevValue=this.model.value,this._buttonDiv&&this._buttonDiv.find(".e-drp-apply").addClass("e-disable"),this._trigger("_change",{value:this.model.value})},i.prototype._bindDateButton=function(){this.dateRangeicon&&this._on(this.dateRangeIcon,"click",this._showDatePopUp),this.model.allowEdit||(this.element.attr("readonly","readonly"),this.element.on("mousedown",$.proxy(this._showDatePopUp,this)),this.element.off("blur",$.proxy(this._onMainFocusOut,this))),this.model.allowEdit&&this.element.off("mousedown",$.proxy(this._showDatePopUp,this))},i.prototype._showDatePopUp=function(e){if(!this.model.enabled)return!1;var t=!1;e.button?t=2==e.button:e.which&&(t=3==e.which),t||this._showhidePopup(e)},i.prototype._showhidePopup=function(e){this._popupOpen?(this._isFocused||!this.element.is(":input")||ej.isTouchDevice()||this.wrapper.addClass("e-focus"),this.popupHide(e)):(this._isFocused||!this.element.is(":input")||ej.isTouchDevice()||this.wrapper.addClass("e-focus"),this.popupShow(e))},i.prototype.popupHide=function(e){if(!this._popupOpen||this._isPopScroll)return!1;var t=this;this._trigger("beforeClose",{element:this.popup,events:e}),this.popup.attr({"aria-hidden":"true"}),this._leftTP&&!this._leftTP._popupOpen&&this._leftTP.hide(),this._rightTP&&!this._rightTP._popupOpen&&this._rightTP.hide(),this.popup.css("visibility","visible").slideUp(100,function(){t._popupOpen=!1}),this._off(ej.getScrollableParents(this.wrapper),"scroll",$.proxy(this.popupHide,this)),this._trigger("close",{element:this.popup,events:e}),this.wrapper.removeClass("e-active")},i.prototype.popupShow=function(e){if(!this.model.enabled||this._popupOpen)return!1;this._trigger("beforeOpen",{element:this.popup,events:e}),this.wrapper.addClass("e-focus"),this.popup.attr({"aria-hidden":"false"}),this._popupOpen=!0,this.popup.css({visibility:"hidden",display:"block"}),this._resizePopup(),this.popup.css({display:"none",visibility:"visible"}).slideDown(100,function(){}),this._on(ej.getScrollableParents(this.wrapper),"scroll",$.proxy(this.popupHide,this)),this._trigger("open",{element:this.popup,events:e}),this.wrapper.addClass("e-active")},i.prototype._resizePopup=function(){var e=this,t=0,i=0,s=e.datePopup.find(".e-popup.e-calendar").outerWidth(),a=e.datePopup.find(".e-popup.e-calendar").height();if(this._customRangePicker&&this._customRangePicker.height()<=0&&this._customRangePicker.height(this.datePopup.height()),this.model.ranges&&this.model.ranges.length>0&&(i=this._customRangePicker.find("ul").height(),t=e._customRangePicker.outerWidth()),$(window).width()-this.wrapper.position().left<2*s+t+25){if(e.popup.addClass("e-daterange-responsive"),e._setOption("width","95%"),this.model.enableTimePicker)return this._setOption("width","47%"),this._setDatePickerPosition(),$("#"+this._id+"_lTime_timewidget").css({left:this._leftDP.wrapper.outerWidth()+5}),$("#"+this._id+"_rTime_timewidget").css({left:this._rightDP.wrapper.outerWidth()+5}),void(e._scrollerObj&&(e._scrollerObj.model.height=i<a?i+10:a,e._scrollerObj.refresh()))}else e.popup.removeClass("e-daterange-responsive"),this.model.enableTimePicker&&(this._leftTP.option("width","100px"),this._rightTP.option("width","100px"),this._setTimePickerPos()),e._scrollerObj&&(e._scrollerObj.model.height=this.datePopup.height(),e._scrollerObj.refresh());this._setDatePickerPosition()},i.prototype._onDocumentClick=function(e){this.model&&($(e.target).is(this.popup)||$(e.target).parents(".e-popup").is(this.popup)||$(e.target).is(this.wrapper)||$(e.target).parents(".e-daterangewidget").is(this.wrapper)||(!this.model.enableTimePicker||$(e.target).is(this._leftTP.popup)||$(e.target).parents(".e-popup").is(this._leftTP.popup)||$(e.target).is(this._rightTP.popup)||$(e.target).parents(".e-popup").is(this._rightTP.popup)||(this._popupOpen&&this.popupHide(e),this.wrapper.removeClass("e-focus")),this.model.enableTimePicker||(this._popupOpen&&this.popupHide(e),this.wrapper.removeClass("e-focus"))))},i.prototype._getOffset=function(e){var t,i=e.offset()||{left:0,top:0};return"static"!=$("body").css("position")&&(t=$("body").offset(),i.left-=t.left,i.top-=t.top),i},i.prototype._getZindexPartial=function(e,t){var i,s,a;if(!ej.isNullOrUndefined(e)&&e.length>0)return i=e.parents(),s=$("body").children(),!ej.isNullOrUndefined(e)&&e.length>0&&s.splice(s.index(t),1),$(s).each(function(e,t){i.push(t)}),a=Math.max.apply(a,$.map(i,function(e){if("static"!=$(e).css("position"))return parseInt($(e).css("z-index"))||1})),!a||a<1e4?a=1e4:a+=1,a},i.prototype._setDatePickerPosition=function(){var e=this.element.is("input")?this.wrapper:this.element,t=this._getOffset(e),i=$(document).scrollTop()+$(window).height()-(t.top+$(e).outerHeight()),s=t.top-$(document).scrollTop(),a=this.popup.outerHeight(),n=this.popup.outerWidth(),r=t.left,l=e.outerHeight(),o=(e.height(),this._getZindexPartial(this.element,this.popup)),h=a<i||a>s?t.top+l+3:t.top-a-3;n>$(document).scrollLeft()+$(window).width()-r&&n<r+e.outerWidth()&&(r-=this.popup.outerWidth()-e.outerWidth()),this.popup.css({left:r+"px",top:h+"px","z-index":o}),this.model.enableTimePicker&&($("#"+this._id+"_lTime_timewidget").css({position:"absolute",top:0,left:this._leftDP.popup.width()+this._leftDP.popup.position().left-$("#"+this._id+"_lTime_timewidget").width()}),$("#"+this._id+"_rTime_timewidget").css({position:"absolute",top:this.popup.hasClass("e-daterange-responsive")?this._rightDP.wrapper.position().top:0,left:this._rightDP.popup.width()+this._rightDP.popup.position().left-$("#"+this._id+"_rTime_timewidget").width()}))},i.prototype._dateEleClicked=function(e){var t,i,s,a,n;this._updateRangesList(),this._activeItem=$(e.currentTarget),this._activeItem.hasClass("e-hidedate")?e.stopPropagation():(this._activeItem.hasClass("other-month")&&this._refreshMinMax(),a=this._activeItem.attr("date"),t=$(e.currentTarget).parents(".e-left-datepicker").length>0?"left":"right",ej.isNullOrUndefined(a)||""===a||(i=new Date(a),null!=this._selectedStartDate&&null!=this._selectedEndDate&&(this._selectedStartDate=null),null==this._selectedStartDate?(this._selectedStartDate=i,this._selectedEndDate=null,this._startDate&&(this._startDate.date=null),this._rightDP.element.val(null),"right"==t&&(this._leftDP._stopRefresh=!0,this._leftDP.option("value",this._selectedStartDate),this._leftDP.element.val(this._selectedStartDate.toLocaleDateString())),this._rightTP&&this._rightTP.option("value",""),this.popup.find(".in-range").removeClass("in-range"),this.datePopup.find("td.e-state-default.e-active").removeClass("e-active"),this._rightDP.element.parents(".e-datewidget").removeClass("e-error"),s=$(this.datePopup.find('.current-month[date="'+a+'"]')),this._selectedStartDate=new Date(s.attr("date")),this._setStartDate(this._selectedStartDate,s,!0)):null===this._selectedStartDate||null!=this._selectedEndDate||i<this._selectedStartDate?(this._selectedStartDate=i,this._selectedEndDate=null,this._endDate&&(this._endDate.date=null),this.popup.find(".in-range").removeClass("in-range"),this._rightDP.option("value",null),this._rightTP&&this._rightTP.option("value",""),"right"==t&&(this._leftDP._stopRefresh=!0,this._leftDP.option("value",this._selectedStartDate),this._leftDP.element.val(this._selectedStartDate.toLocaleDateString())),this._setStartDate(this._selectedStartDate,this._activeItem,!0),this._updateRanges("left"),this._updateRanges("right")):(a=$(e.currentTarget).attr("date"),this._rightDP._stopRefresh=!0,this._rightDP.option("value",new Date(a)),this._rightDP._stopRefresh=!1,this._rightTP&&this._rightTP.option("value",new Date(a)),this._rightDP.element.parents(".e-datewidget").removeClass("e-error"),n=$(this.datePopup.find('.current-month[date="'+a+'"]')),this._selectedStartDate=this.model.startDate,this._selectedEndDate=new Date(a),this._setEndDate(this._selectedEndDate,n,!0),this._startDate={},this._startDate.date=this._selectedStartDate,this._updateRanges("left"),this._updateRanges("right"),"left"==t&&(this._leftDP._stopRefresh=!0,this._leftDP.option("value",this.model.startDate),this._leftDP.element.val(this.model.startDate.toLocaleDateString()))),this._trigger("click",{element:$(e.currentTarget),startDate:this.model.startDate,endDate:this.model.endDate,value:new Date($(e.currentTarget).attr("date"))})))},i.prototype._setStartDate=function(e,t,i){if(this._startDate={},this._startDate.date=e,i&&(this._endDate={},this._endDate.date=null),this._leftDP._checkDateArrows(),this.datePopup.find("td.e-state-default").removeClass("e-select e-start-date e-active showrange e-end-date e-state-hover"),this.popup.find(".in-range").removeClass("in-range"),t.addClass("e-start-date"),this.model.startDate=e,this._buttonDiv&&this._buttonDiv.find(".e-drp-apply").addClass("e-disable"),this.model.enableTimePicker){var s=this._leftTP,a=ej.format(this._leftTP.model.value||this._leftDP.model.value,s.model.timeFormat,this.model.locale);a&&this._rightTP.option("minTime",a),a&&this._leftTP.option("value",a)}},i.prototype._setEndDate=function(e,t){if(this._rightDP.element.parents(".e-datewidget").removeClass("e-val-error"),this._endDate={},this._endDate.date=e,this.popup.find("td.e-end-date").removeClass("e-select e-end-date"),t.addClass("e-end-date"),this._buttonDiv&&this._buttonDiv.find(".e-disable").removeClass("e-disable"),this.model.endDate=e,(this._startDate.date.getFullYear()!=this._endDate.date.getFullYear()||this._startDate.date.getMonth()!=this._endDate.date.getMonth())&&this.model.enableTimePicker)if(this.model.startDate.getDate()==this.model.endDate.getDate())this._rightTP.option("minTime",this._leftTP.option("value")||""),this._rightTP.option("value",this._leftTP.option("value")||"");else{var i=this._rightTP,s=ej.format(this._rightTP.model.value,i.model.timeFormat,this.model.locale);s&&this._rightTP.option("minTime",s),s&&this._rightTP.option("value",s)}},i.prototype._rangeRefresh=function(e){var t,i,s,a;this._rightDP&&(s=e.element.parent().hasClass("e-left-datepicker")?this._leftDP.popup:this._rightDP.popup),this._startDate&&this._startDate.date&&this._startDate.date.getMonth()==e.month&&this._startDate.date.getFullYear()==e.year&&(t=$(s.find('.current-month[date="'+this._startDate.date.toDateString()+'"]')),this._setStartDate(this._startDate.date,t,!1),this._startDate.date.getDate()+1==t.next("td").text()&&$(t).addClass("showrange")),this._endDate&&this._endDate.date&&this._endDate.date.getMonth()==e.month&&this._endDate.date.getFullYear()==e.year&&(i=$(s.find('.current-month[date="'+this._endDate.date.toDateString()+'"]')),this._setEndDate(this._endDate.date,i,!1)),t==i&&$(t).removeClass("showrange"),this._rightDP&&this._startDate&&this._startDate.date&&this._endDate&&this._endDate.date&&this._startDate.date.getFullYear()<=e.year&&this._endDate.date.getFullYear()>=e.year&&(e.element.parent().hasClass("e-left-datepicker"),$(s.find("td.current-month")[0]),a=e.element.parent().hasClass("e-left-datepicker")?"left":"right",this._updateRanges(a))},i.prototype._renderRangesWrapper=function(){ej.isNullOrUndefined(this._customRangePicker)&&(this._customRangePicker=ej.buildTag("div.e-custom-dateranges").css("height",this.datePopup.height()),this.popup.append(this._customRangePicker),this._customRangePicker.insertBefore(this._buttonDiv),this._ranges_li="<ul class='e-dateranges-ul'></ul>",this._customRangePicker.append(this._ranges_li))},i.prototype.setRange=function(e){var t,i;if(this._clearRanges(),"string"==typeof e){for(i=0;i<this.model.ranges.length;i++)if((t=this.model.ranges[i]).label==e)return this.model.startDate=t.range[0],this.model.endDate=t.range[1],void this._updatePreRanges()}else if("object"==typeof e&&2==e.length)return this.model.startDate=e[0],this.model.endDate=e[1],void this._updatePreRanges()},i.prototype._updatePreRanges=function(){this._selectedStartDate=this.model.startDate,this._selectedEndDate=this.model.endDate,this._resetValues(),this._setValues(),this._refreshMinMax(),this._popupOpen||this._mainValue(),this._setWaterMark()},i.prototype.destroy=function(){this.destroy()},i.prototype._destroy=function(){this._popupOpen&&this._showhidePopup(),this.wrapper&&(this.element.removeClass("e-input"),this.element.insertAfter(this.wrapper),this.wrapper.remove()),ej.isNullOrUndefined(this._leftDP)||this._leftDP.destroy(),ej.isNullOrUndefined(this._rightDP)||this._rightDP.destroy(),ej.isNullOrUndefined(this._rightTP)||this._rightTP.destroy(),ej.isNullOrUndefined(this._leftTP)||this._leftTP.destroy(),ej.isNullOrUndefined(this._scrollerObj)||this._scrollerObj.destroy(),this.popup.remove()},i.prototype.addRanges=function(e){var t,i,s,a,n,r="";if(e)for(t=0;t<e.length;t++)2===(s=(i=e[t]).range).length&&(a=new Date(s[0]),n=new Date(s[1]),ej.isNullOrUndefined(a)&&(a=new Date(s[0])),ej.isNullOrUndefined(n)&&(n=new Date(s[1])),a<=n&&(i.label||(i.label="PreDefined Ranges"),r+="<li aria-selected='false' title='"+i.label+"'class='rangeItem' e-date-range='"+JSON.stringify(s)+"' e-data-value='"+i.range+"'>"+i.label+"</li>"));this._renderRangesWrapper(),this._customRangePicker.find(".e-dateranges-ul").append(r),this._off(this._customRangePicker.find("ul li.rangeItem"),"click",this._customSelection),this._on(this._customRangePicker.find("ul li.rangeItem"),"click",this._customSelection),this._scrollerObj&&this._scrollerObj.refresh()},i.prototype._righthoverRange=function(e){var t,i,s;this._activeItem=$(e.currentTarget),this._activeItem.hasClass("e-hidedate")?e.stopPropagation():(this.popup.find(".range-hover").removeClass("range-hover"),this._activeItem.hasClass("in-range")&&this._activeItem.addClass("range-hover"),t=this._activeItem.attr("date"),i=new Date(t),this._trigger("hover",{element:e.currentTarget,events:e,value:new Date(this._activeItem.attr("date"))}),s=this,!ej.isNullOrUndefined(s._selectedStartDate)&&ej.isNullOrUndefined(s._selectedEndDate)&&this.popup.find(".current-month").each(function(e,t){var a,n=$(t),r=n.attr("date");ej.isNullOrUndefined(r)||""===r||((a=new Date(r))>s._startDate.date&&a<i?n.addClass("in-range"):n.removeClass("in-range"),a.getTime()===s._selectedStartDate.getTime()&&0!==n.next().length&&0!==n.next("td.current-month").length&&i>s._selectedStartDate&&new Date(new Date(s._selectedStartDate.getTime()).setDate(s._selectedStartDate.getDate()+1)).getTime()!==i.getTime()?n.addClass("showrange"):n.removeClass("showrange"))}))},i.prototype._customSelection=function(e){if(this._customRangePicker.find(".e-active").removeClass("e-active"),"customPicker"!=$(e.currentTarget).attr("e-date-range")){var t=$(e.currentTarget).attr("e-data-value").split(",");this.model.startDate=new Date(t[0]),this.model.endDate=new Date(t[1]),this._rightDP.element.parents(".e-datewidget").removeClass("e-error"),this._customSet()}else this.model.startDate=null,this.model.endDate=null,this._clearRanges();$(e.currentTarget).addClass("e-active")},i.prototype._setWaterMark=function(){if(null!=this.element&&this.element.hasClass("e-input"))return this._isSupport||""!=this.element.val()?$(this.element).attr("placeholder",this._localizedLabels.watermarkText):this._hiddenInput.css("display","block").val(this._localizedLabels.watermarkText),!0},i.prototype._clearRanges=function(){this._updateRangesList(),this._setOption("value",""),this._rightDP.element.parents(".e-datewidget").removeClass("e-val-error"),this._selectedStartDate=null,this._selectedEndDate=null,this._startDate&&(this._startDate.date=null),this._endDate&&(this._endDate.date=null),this.popup.find("td").removeClass("e-start-date e-end-date in-range e-active e-state-hover today"),this.model.value=null,this.model.startDate=null,this.model.endDate=null,this._buttonDiv&&this._buttonDiv.find(".e-drp-apply").addClass("e-disable")},i.prototype.clearRanges=function(){this._clearRanges(),this._refreshMinMax(),this.element.val(""),this._trigger("_change",{value:this.model.value}),this._trigger("change",{value:this.model.value,startDate:this.model.startDate,endDate:this.model.endDate}),this._trigger("clear",{})},i.prototype._getLocalizedLabels=function(){return ej.getLocalizedConstants("ej.DateRangePicker",this.model.locale)},i.prototype._unWireEvents=function(){this._off($(".e-next",this.popup),"click",$.proxy(this._previousNextHandler,this)),this._off($(".e-prev",this.popup),"click",$.proxy(this._previousNextHandler,this)),this._off($(this._buttonDiv.find("div.e-drp-cancel")),"click",this._cancelButton),this._off($(this._buttonDiv.find("div.e-drp-reset")),"click",this.clearRanges),this._off(this.popup.find(".leftDate_wrapper.e-datepicker.e-js.e-input"),"blur",this._onPopupFocusOut),this._off(this.popup.find(".rightDate_wrapper.e-datepicker.e-js.e-input"),"blur",this._onPopupFocusOut),this.model.allowEdit&&(this._off(this.element,"blur",this._onMainFocusOut),this._off(this.element,"focus",this._onFocusIn),this._off(this.element,"keydown",this._onKeyDown))},i.prototype._onDocumentKeyDown=function(e){"13"==e.keyCode&&!this._buttonDiv.find(".e-drp-apply").hasClass("e-disable")&&this.wrapper.hasClass("e-focus")&&this._buttonDiv.find(".e-drp-apply").click()},i.prototype._wireEvents=function(){this._on($(".e-next",this.popup),"click",$.proxy(this._previousNextHandler,this)),this._on($(".e-prev",this.popup),"click",$.proxy(this._previousNextHandler,this)),this._on($(this._leftDP.sfCalendar.find("table .e-datepicker-months td")),"click",$.proxy(this._previousNextHandler,this));var e=this;this._on($(this._buttonDiv.find("div.e-drp-reset")),"click",this.clearRanges),this._on($(this._buttonDiv.find("div.e-drp-apply")),"click",function(){e._buttonDiv.find(".e-drp-apply").hasClass("e-disable")||(e._isPopScroll=!1,e._updateInput(),e._showhidePopup(),e._buttonDiv.find(".e-drp-apply").addClass("e-disable"),this._trigger("change",{value:this.model.value,startDate:this.model.startDate,endDate:this.model.endDate}),this._trigger("select",{startDate:this.model.startDate,endDate:this.model.endDate,value:this.model.value}))}),this._on($(window),"resize",this._resizePopup),$(document).on("mousedown",$.proxy(this._onDocumentClick,this)),$(document).on("keydown",$.proxy(this._onDocumentKeyDown,this)),this._on($(this._buttonDiv.find("div.e-drp-cancel")),"click",this._cancelButton),this._on(this.popup.find(".leftDate_wrapper.e-datepicker.e-js.e-input"),"blur",this._onPopupFocusOut),this._on(this.popup.find(".rightDate_wrapper.e-datepicker.e-js.e-input"),"blur",this._onPopupFocusOut),this._on(this.popup.find(".leftDate_wrapper.e-timepicker.e-js.e-input"),"blur",this._onPopupFocusOut),this._on(this.popup.find(".rightDate_wrapper.e-timepicker.e-js.e-input"),"blur",this._onPopupFocusOut),this.model.allowEdit&&(this._on(this.element,"blur",this._onMainFocusOut),this._on(this.element,"focus",this._onFocusIn),this._on(this.element,"keydown",this._onKeyDown)),this._on(this._leftDP.element,"keydown",this._onKeyDown),this._on(this._rightDP.element,"keydown",this._onKeyDown),this.popup.on("mouseenter touchstart",$.proxy(function(){this._isPopScroll=!0},this)),this.popup.on("mouseleave touchend",$.proxy(function(){this._isPopScroll=!1},this))},i.prototype._onFocusIn=function(e){this._isSupport&&(e.preventDefault(),this._isFocused=!0),this.wrapper.hasClass("e-error")&&(this._validState=!1,this.wrapper.removeClass("e-error")),this.model.showPopupButton||this.model.readOnly||this.popupShow(e),this.model.showPopupButton||this._on(this.element,"click",this._elementClick),this.wrapper.addClass("e-focus")},i.prototype._onKeyDown=function(e){13==e.keyCode&&($(e.currentTarget).hasClass("e-datepicker")?(this._validateValues($(e.currentTarget).val(),$(e.currentTarget).parents(".e-left-datepicker").length>0?"left":"right"),$(e.currentTarget).parents(".e-left-datepicker").length>0?this._leftDP.model.value=this.model.startDate:this._rightDP.model.value=this.model.endDate,this._onPopupFocusOut(e)):$(e.currentTarget).hasClass("leftTime")?this._leftTP._trigger("select"):this._rightTP._trigger("select")),e.stopImmediatePropagation()},i.prototype._cancelButton=function(){this._prevValue=null,this._isPopScroll=!1,this._clearRanges(),this._onMainFocusOut(),this._showhidePopup()},i.prototype._updateRanges=function(e){var t="left"==e?this._leftDP:this._rightDP,i=this;if(t.popup.find("td.current-month").each(function(e,t){var s,a=$(t),n=a.attr("date");ej.isNullOrUndefined(n)||""===n||(s=new Date(n),ej.isNullOrUndefined(i._startDate)||ej.isNullOrUndefined(i._startDate.date)||ej.isNullOrUndefined(i._endDate.date)||(s>i._startDate.date&&s<i._endDate.date?a.addClass("in-range"):a.removeClass("in-range")),ej.isNullOrUndefined(i._startDate)||ej.isNullOrUndefined(i._startDate.date)||s.toDateString()!=i._startDate.date.toDateString()||(a.addClass("e-start-date"),ej.isNullOrUndefined(i._endDate)||ej.isNullOrUndefined(i._endDate.date)||i._startDate.date.toDateString()==i._endDate.date.toDateString()||a.addClass("showrange"),a.removeClass("in-range")),ej.isNullOrUndefined(i._endDate)||ej.isNullOrUndefined(i._endDate.date)||ej.isNullOrUndefined(i._endDate)||s.toDateString()!=i._endDate.date.toDateString()||(a.addClass("e-end-date"),a.removeClass("in-range")))}),t.popup.find(".e-start-date").length>0){if($(t.popup.find(".e-start-date")).next("td.in-range").length>0)return;$(t.popup.find(".e-start-date")).removeClass("showrange")}},i.prototype.getSelectedRange=function(){return{startDate:this.model.startDate,endDate:this.model.endDate}},i.prototype.enable=function(){this.element[0].disabled=!1,this.model.enabled=!0,this.wrapper.removeClass("e-disable"),this.element.removeClass("e-disable"),this.element.attr("aria-enabled","false"),this.element.attr("enabled","enabled"),this._isSupport||this._hiddenInput.attr("enabled","enabled"),this.dateRangeIcon&&this.dateRangeIcon.removeClass("e-disable").attr("aria-disabled","false"),this.popup.children("div").removeClass("e-disable").attr("aria-disabled","false"),this._setOption("enabled",!0)},i.prototype.disable=function(){this.element[0].disabled=!0,this.model.enabled=!1,this.wrapper.addClass("e-disable"),this.element.addClass("e-disable"),this.element.attr("aria-disabled","true"),this.element.attr("disabled","disabled"),this._isSupport||this._hiddenInput.attr("disabled","disabled"),this.dateRangeIcon&&this.dateRangeIcon.addClass("e-disable").attr("aria-disabled","true"),this.popup.children("div").addClass("e-disable").attr("aria-disabled","true"),this.popupHide(),this._setOption("enabled",!1)},i.prototype._onMainFocusOut=function(){var e,t=this.element.val();if(this.wrapper.removeClass("e-focus"),""!=this.element.val()||null!=this._prevValue){if(this._prevValue&&this._prevValue==this.element.val())return void(this._validState?this.wrapper.removeClass("e-error").removeClass("e-focus"):this.wrapper.addClass("e-error").removeClass("e-focus"));if(this._updateRangesList(),""==this.element.val())return this.wrapper.removeClass("e-error"),this._clearRanges(),this._setWaterMark(),this._refreshMinMax(),this._trigger("change",{value:this.model.value,startDate:null,endDate:null}),void this._trigger("_change",{value:this.model.value});this.wrapper.removeClass("e-error");var i=this.element.val().split(this.model.separator),s=ej.parseDate(i[0],this._dateTimeFormat,this.model.locale),a=ej.parseDate(i[1],this._dateTimeFormat,this.model.locale);if(this._resetValues(),this._validState=!0,this._validateValues(s,"left")&&this._validateValues(a,"right")||(this._clearRanges(),this._refreshMinMax(),e=!0),this._startEndValidation()||(this._clearRanges(),this._refreshMinMax(),e=!0),""!=t&&e)return this.element.val(t),this.wrapper.addClass("e-error"),this.model.value=null,this._validState=!1,this._trigger("_change",{value:this.element.val()}),void this._trigger("change",{value:this.model.value,startDate:null,endDate:null});this._resetValues(),this._setValues(),this._refreshMinMax(),this.model.value=this._validState&&""!=t?t:null,this._popupOpen||this._mainValue(),this._prevValue=this.model.value,this._validState?this.wrapper.removeClass("e-error").removeClass("e-focus"):this.wrapper.addClass("e-error").removeClass("e-focus"),this._trigger("change",{value:this.model.value,startDate:this.model.startDate,endDate:this.model.endDate})}},i.prototype._onPopupFocusOut=function(e){(ej.format(this._selectedStartDate,"M/d/yyyy")!=$("#daterangeleftDate_wrapper").val()||ej.format(this._selectedEndDate,"M/d/yyyy")!=$("#daterangerightDate_wrapper").val())&&this._updateRangesList(),$(e.currentTarget).parents(".e-left-datepicker").length>0?this._leftDP:this._rightDP,this._validateValues($(e.currentTarget).val(),$(e.currentTarget).parents(".e-left-datepicker").length>0?"left":"right"),$(e.currentTarget).parents(".e-left-datepicker").length>0?this._leftDP.model.value=this.model.startDate:this._rightDP.model.value=this.model.endDate;var t=this.model.startDate,i=this.model.endDate,s=!1;this._rightDP.element.parents(".e-datewidget").removeClass("e-val-error"),this._startEndValidation()||($(e.currentTarget).parents(".e-left-datepicker").length>0?(this._clearRanges(),this.model.startDate=t,this._selectedStartDate=this.model.startDate):(this._rightDP.element.parents(".e-datewidget").addClass("e-val-error"),this.model.endDate=null,s=!0)),null!=t?(this._selectedStartDate=this.model.startDate,this._selectedEndDate=this.model.endDate,this._resetValues(),this._setValues(),this.model.showPopupButton||this._off(this.element,"click",this._elementClick),this._refreshMinMax(),this._popupOpen||this._mainValue(),s&&this._rightDP.element.val(i.toLocaleDateString()),this._setWaterMark()):this._clearRanges()},i.prototype._resetValues=function(){this._leftDP.option("maxDate",null),this._rightDP.option("minDate",null),this._leftDP.option("value",this._leftDP.model.value),this._rightDP.option("value",this._rightDP.model.value)},i.prototype._refreshMinMax=function(){var e=this._getNextMonth(this._leftDP._calendarDate);e.toDateString()>this._rightDP._calendarDate.toDateString()&&(t=this._rightDP.model.value,this._rightDP._calendarDate=e,this._rightDP._dateValue=e,this._rightDP.option("value",e)),this._rightDP.option("minDate",e),this._rightDP.option("value",t);var t,i=(t=this._rightDP._calendarDate).getFullYear(),s=t.getMonth();this._leftDP.option("maxDate",new Date(i,s,0))},i.prototype._refreshEvents=function(){this._off(this._rightDP.sfCalendar.find("table .e-datepicker-days td.e-state-default"),"click",this._dateEleClicked),this._off(this._leftDP.sfCalendar.find("table .e-datepicker-days td.e-state-default"),"click",this._dateEleClicked),this._off(this._rightDP.sfCalendar.find("table .e-datepicker-days td.e-state-default"),"mouseover",this._righthoverRange),this._off(this._leftDP.sfCalendar.find("table .e-datepicker-days td.e-state-default"),"mouseover",this._righthoverRange),this._on(this._leftDP.sfCalendar.find("table .e-datepicker-days td.e-state-default"),"mouseover",this._righthoverRange),this._on(this._leftDP.sfCalendar.find("table .e-datepicker-days td.e-state-default"),"click",this._dateEleClicked),this._on(this._rightDP.sfCalendar.find("table .e-datepicker-days td.e-state-default"),"mouseover",this._righthoverRange),this._on(this._rightDP.sfCalendar.find("table .e-datepicker-days td.e-state-default"),"click",this._dateEleClicked),this._on($(this._leftDP.sfCalendar.find("table .e-datepicker-months td")),"click",$.proxy(this._previousNextHandler,this))},i.prototype._previousNextHandler=function(e){var t,i,s,a,n,r=$(e.currentTarget).closest(".e-calendar").parent().hasClass("e-left-datepicker")?"left":"right";if("_month_Loaded"==e.type?"left"==r?(i=$(this._rightDP.popup.find("td.current-month")[0]).attr("date"),t=this._leftDP._dateValue.toDateString()):"right"==r&&(t=$(this._leftDP.popup.find("td.current-month")[0]).attr("date"),i=this._rightDP._dateValue.toDateString()):(i=$(this._rightDP.popup.find("td.current-month")[0]).attr("date"),t=$(this._leftDP.popup.find("td.current-month")[0]).attr("date")),s=new Date(t),a=new Date(i),s.setHours(0,0,0,0),a.setHours(0,0,0,0),"right"==r){"e-dp-viewdays"==(n=$("table",this._leftDP.sfCalendar).get(0).className)&&(this._leftDP._stopRefresh=!0),this._rightDP._stopRefresh=!1;var l=a,o=l.getFullYear(),h=l.getMonth();this._leftDP.option("maxDate",new Date(o,h,0)),"e-dp-viewmonths"==n&&this._leftDP._startLevel("year"),this._leftDP._checkDateArrows()}else n=$("table",this._rightDP.sfCalendar).get(0).className,"e-dp-viewdays"==$("table",this._rightDP.sfCalendar).get(0).className&&(this._rightDP._stopRefresh=!0),this._leftDP._stopRefresh=!1,this._rightDP.option("minDate",this._getNextMonth(s)),"e-dp-viewmonths"==n&&this._rightDP._startLevel("year"),this._rightDP._checkDateArrows();this._rightDP.element.parents(".e-datewidget").removeClass("e-error")},i}(ej.WidgetBase);window.ej.widget("ejDateRangePicker","ej.DateRangePicker",new t),window.ejDateRangePicker=null,ej.DateRangePicker.Locale={},ej.DateRangePicker.Locale=ej.DateRangePicker.Locale||{},ej.DateRangePicker.Locale.default=ej.DateRangePicker.Locale["en-US"]={ButtonText:{apply:"Apply",cancel:"Cancel",reset:"Reset"},watermarkText:"Select Range",customPicker:"Custom Picker"}}),$.ajaxSetup({beforeSend:function(e){setXSRFRequestHeader(e)}});
